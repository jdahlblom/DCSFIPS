    ...
    public class FIPHandler
    {
        ...
        public bool Initialize()
        {
            ...
            try
            {
                ...
                if (!File.Exists(@"C:\Program Files\Logitech\DirectOutput\DirectOutput.dll"))
                {
        ...
        public void Close()
        {
            try
            {
                ...
                if (InitOk)
                {
                    Debug.Print("Calling DirectOutputClass.Deinitialize()");
            ...
            Debug.Print("Exiting FIPHandler Close()");
        }
        ...
        private void DeviceCallback(IntPtr device, bool added, IntPtr context)
        {
            try
            {
                ...
                OnFIPCountChanged?.Invoke(_fipPanels.Count);
            }
            catch (Exception ex)
            {
                Common.LogError(12341, ex, "DeviceCallback for FIP " + device);
            }
        }
